  ...
  const faqs = [
    {
      ...
      answer: 'Your physical card will be delivered within 5-7 business days after verification. You can start using it immediately upon arrival.',
      button: 'Track Order',
    },
    {
      question: 'Is my cryptocurrency safe with Stellexion?',
      answer: 'Yes! We use military-grade encryption, cold storage, and blockchain verification to ensure maximum security of your assets.',
      button: 'Learn Security',
    },
    {
      question: 'What countries do you support?',
      answer: 'We currently support 150+ countries worldwide. You can use your Stellexion card anywhere Visa or Mastercard is accepted.',
      button: 'View Supported Countries',
    },
    {
      question: 'What are the transaction fees?',
      answer: 'Our fees are transparent and competitive. Standard transfers: 0.5%, withdrawals: 1%, with no hidden charges ever.',
      button: 'View Pricing',
    },
    {
      question: 'How do I activate my digital wallet?',
      answer: 'After signing up and verifying your identity, you can activate your wallet in just 3 steps through our mobile app or website.',
      button: 'Start Activation',
    },
    {
      question: 'Can I use the card offline?',
      answer: 'Yes! Your Stellexion card works offline at any merchant. Transactions are settled instantly once connection is restored.',
      button: 'See Features',
    },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-light-gray/70 max-w-2xl mx-auto">
            Have questions? We have answers. Check out our FAQ or contact our support team.
          </p>
        </motion.div>
            ...
            >
              ...
              >
                <span className="flex items-center gap-3 text-left">
                  <HelpCircle size={20} className="text-electric-blue flex-shrink-0" />
              ...
              {openIndex === index && (
                ...
                >
                  <p className="text-light-gray/80 mb-4 text-sm">{faq.answer}</p>
        ...
        >
          ...
          <p className="text-light-gray/70 mb-6">Our support team is here to help 24/7</p>
